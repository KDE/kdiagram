...
void AbstractAreaWidget::Private::resizeLayout(AbstractAreaWidget *widget, const QSize &size)
{
    ...
    const QSize innerSize(size.width() - left - right, size.height() - top - bottom);
