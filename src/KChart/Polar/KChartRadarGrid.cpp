...
DataDimensionsList RadarGrid::calculateGrid(const DataDimensionsList &rawDataDimensions) const
{
...
void RadarGrid::drawGrid(PaintContext *context)
{
    ...
    Q_ASSERT_X(plane, "PolarGrid::drawGrid", "Bad function call: PaintContext::coodinatePlane() NOT a polar plane.");
